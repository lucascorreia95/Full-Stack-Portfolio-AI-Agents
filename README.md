# 🧑‍💻 Full-Stack-Portfolio-AI-Agents
...
1. Clone este repositório:
   ...
   ```sh
   git clone https://github.com/lucascorreia95/Full-Stack-Portfolio-AI-Agents.git
   ```

2. Acesse o diretório do projeto:

   ```sh
   cd Full-Stack-Portfolio-AI-Agents
   ```
...
- [Repositório do curso feito para criar essa aplicação](https://github.com/portfolio-projetos-dev/portfoleo/tree/main)
